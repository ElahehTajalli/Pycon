...
export const About = () => (
    <>
        <span className='engAbout' >PyCon is the largest annual gathering for the community that uses and develops the open-source Python programming language. </span>
        <span className='engAbout' >We at promoting and educating people about python programming language. it is an inclusive event and for everyone.</span>
        {/* <span className='engAbout' >Python is a  popular programming language in engineering, science, and industry which is open source and free license.</span> */}
    </>
)


export const FaAbout = () => (
    <>
        <span className='faAbout' >پایکان همایشی برای آشنایی بیشتر با پایتون معرفی جدیدترین دستاوردها و تکنولوژی ها در حوزه های مختلف مرتبط با پایتون می باشد. </span>
        <span className='faAbout' >پایکان به نوعی یک دورهمی برای تمام کسانی است که به نوعی از پایتون در کارهای خود استفاده می کنند. </span>
