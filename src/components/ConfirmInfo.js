        ...
        return (
            <div className='mainConfirmDiv'>
                ...
                <div className='confirmDiv'>
                    ...
                    {this.props.participant==1 &&
                        <>
                            <p>{this.props.workplaceName}     <b>: نام شرکت</b></p>
                            <p>{this.props.workplacePhone}     <b>: شماره تلفن شرکت</b></p>
                        </>
                    }
                    {this.props.participant==2 &&
                        <>
                            <p>{this.props.uniName}     <b>: نام دانشگاه</b></p>
                            <p>{this.props.studentId}     <b>: شماره دانشجویی </b></p>
                        </>
                    }
